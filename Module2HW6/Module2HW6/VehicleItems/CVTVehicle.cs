...
{
    public class CVTVehicle : AutomaticTransmissionVehicle, ICVTVehicle
    {
        public CVTVehicle(decimal price, double fuelConsumption, string manufacturer, string typeOfAutomTransm)
        ...
        {
            base.Drive();
            Console.WriteLine("It is continuously variable transmission vehicle.");
        }
